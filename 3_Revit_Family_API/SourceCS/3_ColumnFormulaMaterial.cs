#region Copyright
//
// (C) Copyright 2009-2019 by Autodesk, Inc.
//
...
/// --------
///
/// In the previous rfa labs (lab1 & lab2), we have defined a column family, using a L-shape profile.
///
///       5 Tw 4
///        +-+
///        | | 3          h = height
...
///
///   1. add two formulas: Tw = Width / 4.0; Td = Depth / 4.0;
///   2. add materials: create a material parameter and assign with a material (e.g. "Glass")
///
