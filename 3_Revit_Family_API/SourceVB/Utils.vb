...
Public Class Utils
  ...
  ''
  Public Shared Function FindElements(ByVal rvtDoc As Document,
                          ByVal targetType As Type, ByVal targetName As String,
  ...
  ''
  Public Shared Function FindElement(ByVal rvtDoc As Document,
                         ByVal targetType As Type, ByVal targetName As String,
