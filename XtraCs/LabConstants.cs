...
namespace XtraCs
{
  ...
  static class LabConstants
  {
    ...
    public const string FilePath = _temp_dir + "RevitElements.txt";
    #endregion
    ...
    private const string _libPath2 = @"C:\ProgramData\Autodesk\RVT 2019\Libraries\India\Structural Connections\Mounting Parts\Fastening Plates\";

    public const string WholeFamilyFileToLoad1 = _libPath + "M_C-Channel.rfa"; // has TXT catalog file
    public const string WholeFamilyFileToLoad2 = _libPath2 + "M_Plate.rfa"; // no TXT catalog file
